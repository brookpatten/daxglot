---
layout: Conceptual
title: DAX overview - DAX | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/dax/dax-overview
...
locale: en-us
document_id: 4c358b88-dbca-7784-6529-c7b4a30c1805
document_version_independent_id: a806ac49-6c55-18ff-b851-e030069e574f
updated_at: 2026-01-13T22:02:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/query-docs-pr/blob/live/query-languages/dax/dax-overview.md
gitcommit: https://github.com/MicrosoftDocs/query-docs-pr/blob/db4161bd161a16808f41898383ed50e440b52823/query-languages/dax/dax-overview.md
...
word_count: 6310
asset_id: dax-overview
moniker_range_name: 
monikers: []
item_type: Content
source_path: query-languages/dax/dax-overview.md
cmProducts:
- https://authoring-docs-microsoft.poolparty.biz/devrel/540ac133-a371-4dbb-8f94-28d6cc77a70b
spProducts:
- https://authoring-docs-microsoft.poolparty.biz/devrel/60bfc045-f127-4841-9d00-ea35495a5800
platformId: 25d5fe63-9ccb-91bd-b101-6144e17dc41a
---
...
To learn more, see: [Measures in Power BI Desktop](/en-us/power-bi/transform-model/desktop-measures)[Measures in Analysis Services](/en-us/analysis-services/tabular-models/measures-ssas-tabular)[Measures in Power Pivot](https://support.office.com/article/Measures-in-Power-Pivot-86484821-a324-4da3-803b-82fd2e5033f4)
...
To learn more, see: [Calculated columns in Power BI Desktop](/en-us/power-bi/transform-model/desktop-calculated-columns)[Calculated columns in Analysis Services](/en-us/analysis-services/tabular-models/ssas-calculated-columns)[Calculated Columns in Power Pivot](https://support.office.com/article/calculated-columns-in-power-pivot-a0eb7167-33fc-4ade-a23f-fb9217c193af).
...
To learn more, see: [Calculated tables in Power BI Desktop](/en-us/power-bi/transform-model/desktop-calculated-tables)[Calculated tables in Analysis Services](/en-us/analysis-services/tabular-models/create-a-calculated-table-ssas-tabular).
...
To learn more, see: [Row-level security (RLS) with Power BI](/en-us/power-bi/admin/service-admin-rls)[Roles in Analysis Services](/en-us/analysis-services/tabular-models/roles-ssas-tabular)
...
You can create measures as part of the query. Measures exist only for the duration of the query. To learn more, see [DAX queries](dax-queries).
...
To learn more about how to create filters within formulas, see the [FILTER Function (DAX)](filter-function-dax). For an example of how filters can be cleared to create grand totals, see the [ALL Function (DAX)](all-function-dax).
